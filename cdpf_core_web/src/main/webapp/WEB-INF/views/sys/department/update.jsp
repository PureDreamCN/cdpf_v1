...
<body>
	...
	<h1 class="page-title">
		组织机构 <small>>>修改部门</small>
	</h1>

	<div class="row">
		<div class="col-md-10">
			<form role="form" id="departmentForm" name="departmentForm"
				class="form-horizontal" action="update.htm?id=${sysDepartment.id }"
				method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="name" name="name" type="text"
								...
								value="${sysDepartment.name }" maxlength="20"> 
						...
						<div class="col-md-9">
							<div class="input-group input-xlarge">
								<input id="parentId" type="hidden" name="parentId"
									value="${sysDepartment.parentId}"> 
								<div id="nodeDiv" type="text" name="parentName" readonly="readonly"
									class="form-control  ">
									<span id="parentName">${sysDepartment.parentName}</span> 
								</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:select path="sysDepartment.type"
								...
								<form:options items="${listType}" itemValue="value"
									itemLabel="content" />
							</form:select>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="code" type="text" name="code"
								class="form-control input-inline  input-xlarge" placeholder=""
								value="${sysDepartment.code }" maxlength="20"><label
								id="codeTip"></label>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="displayOrder" type="text" name="displayOrder"
								class="form-control input-inline  input-xlarge" placeholder=""
								value="${sysDepartment.displayOrder }" maxlength="6"><label
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea rows="5" cols="60" id="note" name="note"
								class="form-control input-inline input-xlarge" maxlength="100">${sysDepartment.note }</textarea>
...
<critc-script> 
<script src="${staticServer }/assets/zTree3.5/js/jquery.ztree.all-3.5.min.js" type="text/javascript"></script> <script type="text/javascript">
