...
<div class="row col-md-10 col-md-offset-1">
    <form id="userForm" name="userForm" class="form-horizontal " enctype="multipart/form-data"  accept="image/*"
          >
        ...
        <div class="form-actions">
            <div class="row">
                <div class="col-md-offset-4 col-md-6">
                    <button type="button" onclick="save()" class="btn btn-primary"><i class="fa fa-save"/></i> 保存
                    </button>
