        ...
        <div class="table-responsive">
            <table class="searchTable">
                <tr>
                    ...
                    <td>状态：</td>
                    <td><form:select path="sysUserSearchVO.status" class="form-control input-medium"
                                     id="cmbStatus">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            ...
                            <input id="departmentName" type="text" readonly="readonly" name="departmentName"
                                   class="form-control " placeholder=""
                                   value="${sysUserSearchVO.departmentName}">
                            <span class="input-group-btn"/>
                            <button class="btn btn-primary" onclick="javascript:showSelTree()"
                                    type="button"><i
            ...
            <div>
                ...
                <button class="btn btn-primary" id="importUser">
                    <i class="fa fa-cloud-upload"></i> 导入
                </button>
                <button class="btn btn-primary" id="outportUser">
    ...
    <script type="text/javascript">
        ...
        var searchUser = function () {
            ...
            if ($("#departmentName").val() != '')
                url += "&departmentName=" + $("#departmentName").val();
