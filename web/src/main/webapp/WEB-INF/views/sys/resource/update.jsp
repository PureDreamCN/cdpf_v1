...
<body>
	...
	<h1 class="page-title">
		资源管理 <small>>>修改模块</small>
	</h1>

	<div class="row">
		<div class="col-md-8">
			<form role="form" id="resouceForm" name="resouceForm"
				class="form-horizontal" action="update.htm?id=${sysResource.id }"
				method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							...
							<select id="resourceLevel" name="resourceLevel"
								...
								<c:if test="${sysResource.resourceLevel eq 1 }">
									<option id="ptsel" value="1" selected="selected">平台管理</option>
									<option id="ptsel2" value="0">应用系统</option>
								</c:if>
								<c:if test="${sysResource.resourceLevel eq 0 }">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="code" type="text" name="code"
								...
								value="${sysResource.code }" maxlength="40"><label id="codeTip"></label>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label">模块链接：</label>
						<div class="col-md-9">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input id="displayOrder" type="text" name="displayOrder"
								...
								value="${sysResource.displayOrder }" maxlength="6"><label
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea id="description" name="description"
								class="form-control input-inline  input-xlarge " rows="3 " maxlength= "50" placeholder="只能输入50个字符">${sysResource.description }</textarea>
						</div>
