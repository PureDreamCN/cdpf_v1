...
public class SysUserDao extends BaseDao<SysUser, SysUserSearchVO> {
    ...
    public int add(SysUser sysUser) {
        String sql = "insert into t_sys_user(id,username,password,randomcode,status,realname,mobile,created_at," +
                "created_by,role_id,department_id,pinyin,email,nation,gender,political,education," +
    ...
    public SysUser get(int id) {
        String sql = "select t.id,t.id,t.username,t.password,t.randomcode,t.status,t.realname,t.mobile,t.avatar,t" +
                ...
                "t.idcard,t.telephone,t.post,t.job_title,t.display_order,t.last_login_date,(select name " +
