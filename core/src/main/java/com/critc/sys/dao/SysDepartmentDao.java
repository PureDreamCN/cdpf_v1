...
public class SysDepartmentDao extends BaseDao<SysDepartment, SysDepartment> {
	 ...
	 * @author 李红 created on 2017年10月30日
	 */
	public List<ComboboxVO> listType() {
		String sql = "select code value,name content from t_sys_dic where category='DEPARTMENT_TYPE' and code is not null order by display_order ";
