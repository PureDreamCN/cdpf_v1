...
import com.critc.sys.dao.SysRoleResourceDao;
import com.critc.sys.model.SysResource;
import com.critc.sys.model.SysRole;
import com.critc.sys.model.SysRoleResource;
...
public class SysRoleService {
	...
	public String createMenuStr(int role_id, int resourceLevel, int themeStyle) {
		...
		if (menu == null) {
			...
			List<SysResource> listResource = sysResourceDao.listByType(1);// 模块列表
